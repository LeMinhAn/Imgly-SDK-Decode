...
public enum Edge {
     ...
     *            snap to the image
     */
    public void adjustCoordinate(float x, float y, @NonNull Rect imageRect, float imageSnapRadius, float aspectRatio) {
     ...
     */
    public void snapToView(@NonNull View view) {
     ...
     * rectangle.
     */
    public boolean isOutsideFrame(@NonNull Rect rect) {
     ...
     */
    private static float adjustRight(float x, @NonNull Rect imageRect, float imageSnapRadius, float aspectRatio) {
     ...
     */
    private static float adjustTop(float y, @NonNull Rect imageRect, float imageSnapRadius, float aspectRatio) {
     ...
     */
    private static float adjustBottom(float y, @NonNull Rect imageRect, float imageSnapRadius, float aspectRatio) {
